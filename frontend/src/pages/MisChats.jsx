...
import { MessageSquare, Search, Building2, User, Clock, ChevronRight, Inbox, Filter } from 'lucide-react';
...
export default function MisChats() {
    ...
    const cargarChats = async () => {
        ...
        try {
            ...
            // Auto-seleccionar: priorizar el que viene del state de navegación
    ...
    // Extraer ofertas únicas para el filtro (solo empresa)
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 1.5rem', minHeight: '80vh' }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
                <h1 style={{ fontSize: '2rem', color: 'var(--text-dark)', margin: '0 0 6px 0', fontWeight: '800', letterSpacing: '-0.5px' }}>
                    Mis Conversaciones
                </h1>
                <p style={{ color: 'var(--text-gray)', margin: 0, fontSize: '1rem' }}>
                    {rol === 'empresa'
                        ...
                        {chatActivo ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div>
                                        <p style={{ margin: 0, fontWeight: '700', color: 'var(--text-dark)', fontSize: '1rem' }}>
                                            {chatActivo.nombre}
                                        </p>
                                    ...
                                    {rol === 'empresa' && chatActivo.candidato_id && chatActivo.oferta_id && (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color: 'var(--primary)', borderRadius: '10px', padding: '7px 14px',
                                                fontWeight: 'bold', fontSize: '0.85rem', cursor: 'pointer', transition: 'all 0.2s'
                                            }}
                                            onMouseOver={e => e.currentTarget.style.background = 'rgba(0,214,107,0.15)'}
